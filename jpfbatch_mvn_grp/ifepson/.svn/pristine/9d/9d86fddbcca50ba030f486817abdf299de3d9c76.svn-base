...
/**
* Comando: ObtenerConfiguracionDePreferenciasTiqueNC, <br>
* Obtiene los valores de configuración para la emisión de tique o tique-nota de crédito que se encuentran almacenados en la memoria de trabajo.<br>
* Notas: <br>
* Requerimientos: <br>
...
* 
*/
public class ObtenerConfiguracionDePreferenciasTiqueNC extends TipoComandoFiscal {
