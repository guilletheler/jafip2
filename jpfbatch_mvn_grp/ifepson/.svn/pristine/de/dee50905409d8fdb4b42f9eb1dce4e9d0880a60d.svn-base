...
/**
* Comando: InformacionDeIVATiqueNC, InformacionIVATiqueNC, <br>
* Información de IVA<br>
...
* 
*/
public class InformacionDeIVATiqueNC extends TipoComandoFiscal {

    public InformacionDeIVATiqueNC() {
    }

    @Override
    public String[] getNames() {
        return new String[]{"InformacionDeIVATiqueNC", "InformacionIVATiqueNC"};
    }
