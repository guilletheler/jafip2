...
/**
* Comando: PagosNotaCreditoABCM, <br>
* Aplica un pago al tique-nota de crédito A/B/C/M en proceso de emisión.<br>
* Notas: La impresión de las líneas de pagos se efectúa en el momento del cierre del tique-nota de crédito.<br>
...
* 
*/
public class PagosNotaCreditoABCM extends TipoComandoFiscal {

    public PagosNotaCreditoABCM() {
    }

    @Override
    public String[] getNames() {
        return new String[]{"PagosNotaCreditoABCM"};
    }

    @Override
    public String getDescripcion() {
        return "Aplica un pago al tique-nota de crédito A/B/C/M en proceso de emisión.";
    }

    @Override
    public String getNotas() {
        return "La impresión de las líneas de pagos se efectúa en el momento del cierre del tique-nota de crédito.\n"
