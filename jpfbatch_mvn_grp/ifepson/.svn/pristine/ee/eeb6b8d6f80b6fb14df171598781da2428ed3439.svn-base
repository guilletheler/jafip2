...
/**
* Comando: CerrarDNFH, <br>
* Realiza el cierre del DNFH.<br>
* Notas:  El total del documento debe ser igual o superior a cero.<br>
...
* Campos de salida: <br>
* 1	N_E	8	Número de documento<br>
* 2	L	1	Reservado<br>
* 3	N_10_2	12	Monto total del documento<br>
* 4	N_10_2	12	Monto total de IVA del documento<br>
* 5	N_10_2	12	Vuelto final<br>
* 
*/
public class CerrarDNFH extends TipoComandoFiscal {
    ...
    public TipoCampoFiscal[] getCamposSalida() {
        return new TipoCampoFiscal[]{
            new TipoCampoFiscal(this, 1, "Número de documento", TipoDato.N_E, 8, false),
            new TipoCampoFiscal(this, 2, "Reservado", TipoDato.L, 1, false),
            new TipoCampoFiscal(this, 3, "Monto total del documento", TipoDato.N_10_2, 12, false),
            new TipoCampoFiscal(this, 4, "Monto total de IVA del documento", TipoDato.N_10_2, 12, false),
