...
/**
* Comando: InformacionDeImpuestosInternosTiqueNC, InformacionImpuestosInternosTiqueNC, <br>
* Obtiene información detallada sobre los impuestos internos involucrados en el tique fiscal en curso.<br>
...
* Requerimientos: Documento Tique, tique-nota d ecrédito abierto.<br>
...
* 
*/
public class InformacionDeImpuestosInternosTiqueNC extends TipoComandoFiscal {
