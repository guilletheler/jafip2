...
/**
* Comando: ItemTiqueFactNDABCM, <br>
* Item<br>
...
* preferencias.<br>
* El monto facturado de la línea de ítem surge de multiplicar la cantidad por el precio unitario y<br>
* redondear el valor obtenido a dos dígitos decimales.<br>
...
* Los bits Bit 6-7 son sólo aceptados en un ítem de venta o anulación ítem de venta.<br>
...
* El contador de ítems contabilizados como unidad (bulto) no disminuye a menos de cero.<br>
...
*  No haber alcanzado el máximo número de ítems dentro de un tique.<br>
*  No haber efectuado descuentos o ajustes o pagos dentro del tique.<br>
...
* Campos de salida: <br>
* 1	N_10_2	12	Subtotal parcial del tique-factura o tique-nota de débito<br>
* 
*/
public class ItemTiqueFactNDABCM extends TipoComandoFiscal {

    public ItemTiqueFactNDABCM() {
    }

    @Override
    public String[] getNames() {
        return new String[]{"ItemTiqueFactNDABCM"};
    }
    ...
    public TipoCampoFiscal[] getCamposSalida() {
        return new TipoCampoFiscal[]{
            new TipoCampoFiscal(this, 1, "Subtotal parcial del tique-factura o tique-nota de débito", TipoDato.N_10_2, 12, false)
        };
    }
