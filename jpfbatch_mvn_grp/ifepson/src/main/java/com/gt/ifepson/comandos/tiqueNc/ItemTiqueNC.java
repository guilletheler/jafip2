...
* 10	N_0_8	8	Coheficiente de impuestos internos porcentuales (OPCIONAL)<br>
...
* 
*/
public class ItemTiqueNC extends TipoComandoFiscal {
    ...
    public TipoCampoFiscal[] getCamposEntrada() {
        return new TipoCampoFiscal[]{
            ...
            new TipoCampoFiscal(this, 10, "Coheficiente de impuestos internos porcentuales", TipoDato.N_0_8, 8, true),
