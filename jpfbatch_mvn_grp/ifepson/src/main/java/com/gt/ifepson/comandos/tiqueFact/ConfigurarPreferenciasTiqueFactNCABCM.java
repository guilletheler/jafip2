...
/**
* Comando: ConfigurarPreferenciasTiqueFactNCABCM, <br>
* Configura las diferentes opciones para la emisión de tique-factura o nota de débito fiscales.<br>
...
* 
*/
public class ConfigurarPreferenciasTiqueFactNCABCM extends TipoComandoFiscal {

    public ConfigurarPreferenciasTiqueFactNCABCM() {
    }

    @Override
    public String[] getNames() {
        return new String[]{"ConfigurarPreferenciasTiqueFactNCABCM"};
    }

    @Override
    public String getDescripcion() {
        return "Configura las diferentes opciones para la emisión de tique-factura o nota de débito fiscales.";
    }
