...
public class MkDist {
    ...
    public static void main(String... args) {
        try {
            ...
            Files.copy(Paths.get("target/jpfbatch-2.0-SNAPSHOT-jar-with-dependencies.jar"), Paths.get("dist/jpfbatch.jar"), StandardCopyOption.REPLACE_EXISTING);
            ...
            Files.copy(Paths.get("src/main/resources/log4j2.xml"), Paths.get("dist/log4j2.xml"), StandardCopyOption.REPLACE_EXISTING);
